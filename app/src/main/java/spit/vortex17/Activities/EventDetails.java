...
import spit.vortex17.HelperClasses.*;
        ...
        extends AppCompatActivity
{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_share:
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "Check out the event '"+event_name+"' at VORTEX 17!For more details, download the official app:\n");
    ...
    private void setReminder() {
        ...
        else
        {
            if (isReminderSet)
                ...
                beginTime.set(2017, 9, 12, 9, 0);
                endTime.set(2017, 9, 12, 18, 0);
                ...
                if(Objects.equals(event_name, "Daniel Fernandes")||Objects.equals(event_name,"Techshiksha"))
                    ...
                    day=new CharSequence[]{"Day 1","Day 2","Day 3", "Day 4"};
                builder.setItems(day, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        {
                            beginTime.set(2017, 9, 13, 9, 0);
                            endTime.set(2017, 9, 13, 18, 0);

                            goToCalendar(beginTime, endTime);
                        }
                        else if(i == 2)
                        {
                            beginTime.set(2017, 9, 14, 9, 0);
                            endTime.set(2017, 9, 14, 18, 0);

                            goToCalendar(beginTime, endTime);
                        }
                        else
                        {
                            beginTime.set(2017, 9, 15, 9, 0);
                            endTime.set(2017, 9, 15, 18, 0);
    ...
    private void goToCalendar(Calendar beginTime, Calendar endTime) {
        ...
        Intent intent = new Intent(Intent.ACTION_INSERT)
                ...
                .putExtra(CalendarContract.Events.DESCRIPTION, "Event at VORTEX 17")
                .putExtra(CalendarContract.Events.EVENT_LOCATION, getIntent().getStringExtra("venue")+", I.C.T,Matunga")
