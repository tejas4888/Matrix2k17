    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        emailId_matrix_TextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String to = "pr.vortexict@gmail.com";
        ...
        visitWebsite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.ictmumbai.edu.in/")));
            }
        });
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    case R.id.contact_us_call_one:
                        intent.setData(Uri.parse("tel:" + "+918369583414"));
                        break;
                    case R.id.contact_us_call_two:
                        intent.setData(Uri.parse("tel:" + "+919422426601"));
                        break;
                }
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    case R.id.contact_us_save_one:
                        intent.putExtra(ContactsContract.Intents.Insert.NAME, "Nihar Dighe");
                        intent.putExtra(ContactsContract.Intents.Insert.PHONE, "+918369583414");
                        break;
                    case R.id.contact_us_save_two:
                        intent.putExtra(ContactsContract.Intents.Insert.NAME, "Ankit Dhelriya");
                        intent.putExtra(ContactsContract.Intents.Insert.PHONE, "+919422426601");
                        break;
                }
                startActivity(intent);
            }
