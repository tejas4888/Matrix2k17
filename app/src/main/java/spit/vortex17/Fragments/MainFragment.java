...
public class MainFragment extends Fragment {
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        public Fragment getItem(int position) {
            EventListFragment megaEventPage = EventListFragment.newInstance("General");
            EventListFragment techEventPage =  EventListFragment.newInstance("Prodigy");
            EventListFragment funEventPage =  EventListFragment.newInstance("Flagship");
            EventListFragment teEventPage =  EventListFragment.newInstance("Pharma");
            switch (position) {
                case 0:
        ...
        public CharSequence getPageTitle(int position) {
            switch (position){
                ...
                case 1:return "Prodigy";
                case 2:return "Flagship";
                case 3: return "Pharma";
            }
            return null;
        }
    }
